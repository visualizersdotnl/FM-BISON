...
namespace SFM
{
	...
	*/
	...
	const float kMaxCompAttack       =   1.f;
	const float kDefCompAttack       = 0.09f; // Tested default
	...
	const float kMaxWahRate          = 1.284220f;  // Taken from synth-DX7-LFO-table.h (first 8 values)
